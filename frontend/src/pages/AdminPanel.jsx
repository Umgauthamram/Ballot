...
const AdminPanel = () => {
  const { users, generateUsers, transactions, polls, createPoll, togglePollStatus, departments } = useApp();
  ...
  // User Generation State removed - moved to UserGenerator.jsx
  ...
  const handleCreatePoll = (e) => {
    ...
    createPoll({
      ...
      candidates,
      durationInHours: newPoll.durationInHours
    });
  ...
  // handleGenerateUsers removed - moved to UserGenerator.jsx
      ...
      <div className="lg:col-span-2 flex flex-col gap-6">
        ...
        <div className="flex border-b border-white/20 overflow-x-auto bg-black/50">
          <button
            ...
            className={`px-8 py-5 text-sm font-bold uppercase flex items-center gap-3 whitespace-nowrap transition-all ${activeTab === 'POLLS' ? 'bg-white text-black' : 'text-gray-500 hover:text-white'
              }`}
          >
          ...
          <button
            ...
            className={`px-8 py-5 text-sm font-bold uppercase flex items-center gap-3 whitespace-nowrap transition-all ${activeTab === 'STUDENTS' ? 'bg-white text-black' : 'text-gray-500 hover:text-white'
              }`}
          >
                  ...
                  <form onSubmit={handleCreatePoll} className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="md:col-span-2">
                        <label className="text-sm uppercase text-gray-500 mb-3 block">Election Duration (Hours)</label>
                        <input
                          type="number"
                          min="1"
                          max="72"
                          placeholder="24"
                          value={newPoll.durationInHours || ''}
                          onChange={(e) => setNewPoll({ ...newPoll, durationInHours: parseInt(e.target.value) })}
                            ...
                            return (
                              <div key={cId} className="flex flex-col gap-2">
                                ...
                                <div className="w-full h-4 bg-gray-800 relative overflow-hidden">
                                  <div
                                    className={`absolute inset-0 transition-all duration-1000 ${isWinner
                  ...
                  {users
                    ...
                    .map(u => (
                      ...
                      >
                        ...
                        <td className="p-6">
                          <span
                            className={`inline-block px-4 py-1 text-sm uppercase font-bold border ${u.status === 'verified'
            ...
            <div className="bg-white text-black p-6 flex justify-between items-start">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span className={`px-2 py-0.5 text-xs font-bold uppercase border border-black ${viewStudent.status === 'verified' ? 'bg-green-400' : 'bg-red-400'
                    }`}>
                    {viewStudent.status}
                  </span>
